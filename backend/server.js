...
What is process?
process is a built-in Node.js object. It gives information and control over the current Node.js application. process is giving your Node application access to different process-level features. for example: process.env.PORT, process.env.PORT, process.on(...)

What is .on()?
Definition: .on() registers a listener. 
