...
const Cart = ({ setOpenCart, isEvent }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10 overflow-y-scroll">
      <div className="fixed top-0 right-0 min-h-full w-full 800px:w-[25%] bg-white flex flex-col justify-between shadow-sm ">
        {cart && cart.length === 0 ? (
      ...
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center">
          ...
          <Link
            ...
            onClick={() => setOpenCart(false)}
          >
            <div className="w-[100px] h-[100px] ml-2 mr-2 flex-shrink-0 bg-gray-50 border rounded-[5px] flex items-center justify-center overflow-hidden">
              <img
